...
public class BoardEndpointsTest {
    ...
    public void shouldCreateMovement() {
        ...
        val entity = this.restTemplate.postForEntity("http://localhost:8080/boards/players/1/movements", request, MovementResource.class);
    ...
    public void shouldGetPlayer() {
        val entity = this.restTemplate.getForEntity("http://localhost:8080/boards/players/1", PlayerResource.class);
